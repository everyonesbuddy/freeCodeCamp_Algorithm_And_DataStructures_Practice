//Create a function that sum two arguments together. if only one argument is provided, then return a function that expects one argument and returns the sum.
